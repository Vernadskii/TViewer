...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  profiles = {
     ...
     * @request GET:/profiles/{name}/configuration/
     */
    configurationDetail: (name: string, params: RequestParams = {}) =>
      this.request<Configuration, any>({
        path: `/profiles/${name}/configuration/`,
        method: "GET",
        format: "json",
        ...params,
      }),
     ...
     * @request GET:/profiles/{name}/historical-data/
     */
    historicalDataDetail: (
      name: string,
      query: {
        /**
         * Name of indicator or just price (which сorresponds with table name)
         * @example "Q_indicator"
         */
        indicator: string;
        /**
         * Amount of seconds for candlesticks interval
         * @example 60
         */
        timeframe: number;
      },
      ...
      this.request<HistoricalData, any>({
        path: `/profiles/${name}/historical-data/`,
        method: "GET",
        query: query,
        format: "json",
        ...params,
